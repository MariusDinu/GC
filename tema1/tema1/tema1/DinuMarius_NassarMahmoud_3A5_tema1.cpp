...
void Display1() {
    ...
    //traseaza linie separata fara drum
...
void Display2() {
    glColor3f(1, 0.1, 0.1); // rosu
    glBegin(GL_LINES);
    //traseaza linie de la punctul de start pana la urmatorul punct dat
    glVertex2f(1.0, 1.0);
    glVertex2f(0.9, 0.9);
    glVertex2f(0.8, 0.8);
    glVertex2f(0.7, 0.7);
...
void Display3() {
    ...
    glColor3f(1, 0.1, 0.1); // rosu
    glBegin(GL_POINTS);
    //genereaza puncte la coordonatele precizate
    glVertex2d(0.5, 0.5);
    glVertex2d(-0.5, -0.5);
    glVertex2d(0.5, -0.5);
    glVertex2d(-0.5, 0.5);
...
void Display6() {
    ...
    //aici traseaza linii intre puncte alese si coloreaza cu rosu spatiul creat
...
void Display7() {
    ...
    //creaza un poligon si coloreaza spatiul creat
